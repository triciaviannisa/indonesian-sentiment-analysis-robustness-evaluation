...
def typo(model_name, tokenizer_path, model_path, state_path, save_path=None):

    df = pd.read_csv("/path/to/smsa_typo_perturbation.csv")
    ...
    print(f"Behavioral Test Results ({model_name}):")
